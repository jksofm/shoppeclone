...
export default function NotFoundPage() {
  return (
    <main className='flex h-screen w-full flex-col bg-gray-100 items-center justify-center'>
      ...
      <button className='mt-5'>
        ...
        >
          <span className='absolute inset-0 translate-x-0.5 translate-y-0.5 bg-primary-color transition-transform group-hover:translate-y-0 group-hover:translate-x-0' />
